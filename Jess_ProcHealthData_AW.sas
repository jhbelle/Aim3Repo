...
data One;
set data.asthma_wheeze; /*[insert your health dataset]*/
where mdy(1,1,2003)<=admitdate<=mdy(12,31,2005); /*[insert your time period]*/
keep admitdate zip5 as_whz_any;
proc contents;
run;
...
data four;
set three;
if as_whz_any ge 1 and i=0 then delete;
run; 
...
data sixA sixB;
set five;
if as_whz_any ge 1 then output sixA;
else output sixB;
run;
...
CloudGapFillIQR = CloudGapFill/7.164936;
NoCldGapFillIQR = NoCldGapFill/7.231744;
UnGapFillIQR = UnGapFill/7.371046;
